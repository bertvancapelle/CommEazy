...
export function BooksProvider({ children }: BooksProviderProps) {
  ...
  // formatSecondsToTime uses the shared formatTime helper from booksContextTypes
  const formatSecondsToTime = formatTime;
...
// Re-export types and helpers from booksContextTypes
export { formatTime } from './booksContextTypes';
export type {
  VoiceQualityStatus,
  BookMode,
  AudioProgress,
