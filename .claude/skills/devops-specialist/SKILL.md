...
description: >
  ...
  automated accessibility audits, screenshot generation for 5 languages
...
- Automated screenshot generation (5 languages × device sizes)
...
lane :release_ios do
  ...
  # Automated screenshots in 5 languages
  capture_screenshots(
    languages: ["nl-NL", "en-US", "de-DE", "fr-FR", "es-ES"],
...
### Screenshot Automation (5 Languages × Devices)
```
Total screenshots needed:
  iOS: 5 languages × 4 devices × ~6 screens = 120 screenshots
  Android: 5 languages × 3 devices × ~6 screens = 90 screenshots
  Total: 210 screenshots per release
...
jobs:
  ...
  i18n-validation:
    runs-on: ubuntu-latest
    steps:
      - run: npm run test:i18n     # All 5 languages complete
...
- **Automated screenshot generation**: Ensures store screenshots are always current and in all 5 languages
...
- [ ] Screenshots automated for 5 languages × all devices
