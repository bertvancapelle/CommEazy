...
**i18n keys (VERPLICHT in alle 12 talen):**
```json
{
  "voiceCommands": {
...
**Multi-taal:**
- [ ] Voice commands werken in alle 12 talen
...
- [ ] i18n: accessibility labels translated in 12 languages
...
- [ ] **Control labels:** Alle labels in 12 talen beschikbaar
